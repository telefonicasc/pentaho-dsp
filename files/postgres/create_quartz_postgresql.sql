...
CREATE USER "%PREFIX%pentaho_user" PASSWORD '%QUARTZ_PASSWORD%';

CREATE DATABASE "%PREFIX%quartz" WITH OWNER = "%PREFIX%pentaho_user" ENCODING = 'UTF8' TABLESPACE = pg_default;

GRANT ALL PRIVILEGES ON DATABASE "%PREFIX%quartz" to "%PREFIX%pentaho_user";

--End--
--Begin Connect--
\connect "%PREFIX%quartz" "%PREFIX%pentaho_user"
...
ALTER TABLE qrtz5_job_listeners OWNER TO "%PREFIX%pentaho_user";
ALTER TABLE qrtz5_trigger_listeners OWNER TO "%PREFIX%pentaho_user";
ALTER TABLE qrtz5_fired_triggers OWNER TO "%PREFIX%pentaho_user";
ALTER TABLE qrtz5_paused_trigger_grps OWNER TO "%PREFIX%pentaho_user";
ALTER TABLE qrtz5_scheduler_state OWNER TO "%PREFIX%pentaho_user";
ALTER TABLE qrtz5_locks OWNER TO "%PREFIX%pentaho_user";
ALTER TABLE qrtz5_simple_triggers OWNER TO "%PREFIX%pentaho_user";
ALTER TABLE qrtz5_cron_triggers OWNER TO "%PREFIX%pentaho_user";
ALTER TABLE qrtz5_blob_triggers OWNER TO "%PREFIX%pentaho_user";
ALTER TABLE qrtz5_triggers OWNER TO "%PREFIX%pentaho_user";
ALTER TABLE qrtz5_job_details OWNER TO "%PREFIX%pentaho_user";
ALTER TABLE qrtz5_calendars OWNER TO "%PREFIX%pentaho_user";
